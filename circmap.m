function   [zet,zetp,cntd,rad]=circmap(et,etp,alphain,n,koebetol,koebemaxit,gmrestol,gmresmaxit,iprec)
%
% The function 
%        circmap
...
if abs(alphain)<inf
    ...
    [zet,zetp,cntd,rad]=circmapu(et,etp,n,koebetol,koebemaxit,gmrestol,gmresmaxit,iprec);
end
%%
end