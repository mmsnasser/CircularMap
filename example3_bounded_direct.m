...
%%
[xh,yh]=meshgrid(-2:0.001:2,[-0.8,-0.6,-0.4,-0.2,-0.1,-0.05,0,0.05,0.1,0.2,0.4,0.6,0.8]);
zh=xh+i.*yh;
zho = 2.*(zh-cent(1));
...
zhv = zh(abs(zh)>=0).';
%%
[xv,yv]=meshgrid([-1.8,-1.6,-1.4,-1.2,-1.1,-1.05,-1.0,-0.95,-0.9,-0.8:0.2:1.8],-1:0.001:1);
zv=xv+i.*yv;
zvo = 2.*(zv-cent(1));
